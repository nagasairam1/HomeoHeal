...
export default function LoginScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.btn} onPress={login}><Text style={{color:'#fff'}}>Login</Text></TouchableOpacity>
      <TouchableOpacity onPress={()=>navigation.navigate("Register")} style={{marginTop:12}}><Text>Create account</Text></TouchableOpacity>
    </View>
  );
}
